            ...
            <form action="{{ route('grup.setorStore', $data->slug) }}" method="POST">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <select data-placeholder="Silahkan Pilih Surat" class="list_quran" name="first_surah_id" id="first_surah_id">
                            <option value=""></option>
                            @foreach ($listQuran as $item)  
                                <option value="{{ $item['number']."-".$item['numberOfVerses'] }}">{{ $item['name']['transliteration']['id']}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select data-placeholder="Silahkan Pilih Ayat" class="list_quran" name="first_ayat" id="first_ayat">
                            <option value=""></option>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select data-placeholder="Silahkan Pilih Ayat" class="list_quran" name="last_ayat" id="last_ayat">
                            <option value=""></option>
                            @for ($i = 1; $i <= $item['numberOfVerses'] ; $i++)
                                <option value="{{ $i }}">{{ $i }}</option>
                            @endfor
